...
{
    public partial class Mission_Mode : Form
    {
        ...
        PictureBox survivor1 = new PictureBox();
        PictureBox survivor2 = new PictureBox();
        PictureBox survivor3 = new PictureBox();
        ...
        private void Mission_Mode_Load(object sender, EventArgs e)
        {
            ...
            Label Survivor = new Label();
            Survivor.Text = "Survivor";
            Survivor.BackColor = Color.Transparent;
            Survivor.Top = this.ClientSize.Height - this.ClientSize.Height * 95 / 100;
            Survivor.Left = this.ClientSize.Width - this.ClientSize.Width * 45/100;
            Survivor.Height = this.ClientSize.Height - this.ClientSize.Height * 95 / 100;
            Survivor.Width = this.ClientSize.Width / 11;
            Survivor.Font = new Font("Arial", this.ClientSize.Width / 65);
            Survivor.ForeColor = Color.White;
            this.Controls.Add(Survivor);
            ...
            survivor1.Image = Properties.Resources.survivordown1;
            survivor1.Top = this.ClientSize.Height - this.ClientSize.Height * 95 / 100;
            survivor1.Left = this.ClientSize.Width - this.ClientSize.Width * 30/100;
            survivor1.Height = this.ClientSize.Height * 8 / 100;
            survivor1.Width = this.ClientSize.Width * 4 / 100;
            survivor1.BackColor = Color.Transparent;

            survivor2.Image = Properties.Resources.survivordown1;
            survivor2.Top = this.ClientSize.Height - this.ClientSize.Height * 95 / 100;
            survivor2.Left = this.ClientSize.Width - this.ClientSize.Width * 32 / 100;
            survivor2.Height = this.ClientSize.Height * 8 / 100;
            survivor2.Width = this.ClientSize.Width * 4 / 100;
            survivor2.BackColor = Color.Transparent;

            survivor3.Image = Properties.Resources.survivordown1;
            survivor3.Top = this.ClientSize.Height - this.ClientSize.Height * 95 / 100;
            survivor3.Left = this.ClientSize.Width - this.ClientSize.Width * 34 / 100;
            survivor3.Height = this.ClientSize.Height * 8 / 100;
            survivor3.Width = this.ClientSize.Width * 4 / 100;
            survivor3.BackColor = Color.Transparent;
            ...
            this.Controls.Add(survivor1);
            this.Controls.Add(survivor2);
            this.Controls.Add(survivor3);
        ...
        private void timerGame_Tick(object sender, EventArgs e)
        {
            ...
            {
                cnt = 0;
                if ((savior == 30 || savior == 32 || savior == 40 || savior == 43 || savior == 8 || savior == 20 || savior == 21 || savior == 10 || savior == 50 || savior == 51 || savior == 52) && saviorOnScreen == false)
                {
                    saviorOnScreen = true;
            ...
            if (saviorOnScreen == true)
            {
                ...
                if (pictureBoxPlayer.Bounds.IntersectsWith(pictureSavior.Bounds))
                {
                    ...
                    if (win==3)
                    {
                        ...
                        listOfHighScore.Add(pointscore);
                        listOfHighScore.Sort();
                        listOfHighScore.Reverse();

                        //menulis score ke dalam txt files
                        StreamWriter sw;
                        sw = new StreamWriter(Application.StartupPath + "/Highscore.txt");
                        ...
                        DialogResult userSelection = MessageBox.Show("Your Score Is : " + pointscore.ToString() + "\nBack to main menu", "      You Win!!!     " ,MessageBoxButtons.OK);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string strFilePath = Application.StartupPath + "/Highscore.txt";
            string strSearchText = listOfHighScore[5].ToString();
            string strOldText;
            string n = "";
            sr = new StreamReader(Application.StartupPath + "/Highscore.txt");
